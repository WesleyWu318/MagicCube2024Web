<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="MagicCubeRegistrationSystem.Registration" %>

<!DOCTYPE html>

<%-- Ivy say hi change file--%>
...
<body>
    <form id="form1" runat="server">
        <div class="jumbotron">
            <h2>學校代碼:&nbsp;
                <asp:Label ID="txtSchoolCode" runat="server" Text="Label"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 校名:&nbsp;
                <asp:Label ID="txtSchoolName" runat="server" Text="Label"></asp:Label>
            </h2>
             <h2>姓名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtTeacherName" runat="server" Font-Size="Large" Height="27px" Width="195px"></asp:TextBox>
            </h2>
